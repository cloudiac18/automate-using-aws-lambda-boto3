...
Name the role `CloudWatchAgentAdminSsmEc2Role`.
...
Assign the `CloudWatchAgentAdminSsmEc2Role` IAM role to the EC2 instance.
...
Topic name: `SSHAlarmNotificationTopic`
